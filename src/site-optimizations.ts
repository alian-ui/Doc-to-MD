...
export const SITE_OPTIMIZATIONS: SitePattern[] = [
  {
 ...
 */
export function detectSiteOptimization(url: string): SitePattern | null {
  for (const pattern of SITE_OPTIMIZATIONS) {
 ...
 */
export function getOptimizedSelectors(url: string) {
