...
/**
 * Doc-to-MD Configurable Crawler CLI
...
const script = path.join(projectRoot, 'src', 'configurable-index.ts');
...
child.on('error', (err) => {
  console.error('Failed to start doc-to-md-configurable:', err.message);
  process.exit(1);
});
